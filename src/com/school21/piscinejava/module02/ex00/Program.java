...
public class Program {
    ...
    private static final String signaturesFilePath = "/home/amalliar/IdeaProjects/piscine-java/src/com/school21/piscinejava/module02/signatures.txt";
    private static final String resultFilePath = "/home/amalliar/IdeaProjects/piscine-java/src/com/school21/piscinejava/module02/result.txt";
    private static final Map<String, String> fileSignaturesMap = new HashMap<>();
    ...
    private static String getFileType(final String filePath) {
        try (FileInputStream fis = new FileInputStream(filePath)) {
            ...
            while (nextByte != -1 && builder.length() <= maxSignatureLength) {
                ...
                String fileType = fileSignaturesMap.get(builder.toString());
                if (fileType != null) {
                    return fileType;
                }
                nextByte = fis.read();
    ...
    private static void loadFileSignatures() {
        try (FileInputStream fis = new FileInputStream(signaturesFilePath)) {
            ...
            while (!nextLine.isBlank()) {
                ...
                fileSignaturesMap.put(valueKeyPair[1], valueKeyPair[0]);
